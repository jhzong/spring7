...
<body>
  ...
  <div class="container">
	...
	<form action="member/doJoin" method="post" name="mFrm">
    <div class="form-box">
      <table>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="gender" placeholder="성별을 입력하시오."></td>
        </tr>
        <tr>
          <td>취미 <span style="color:red"></span></td>
          <td><input type="text" name="hobby" placeholder="취미를 입력하시오."></td>
        </tr>
      </table>
    </div>
    <div class="btn-box">
