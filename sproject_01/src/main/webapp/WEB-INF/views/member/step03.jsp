...
<script type="text/javascript">
	...
	function idCheckBtn(){
		...
		$.ajax({
			...
			success:function(data){
				console.log(data);
				if(data=="able"){
					$("#txt_idCheck").html("<span class='mvalign black'>* 사용 가능한 아이디</span>");
				}else{
					$("#txt_idCheck").html("<span class='mvalign black'>* 이미 존재하는 아이디</span>");
				}
			},
	...
	function pw_check(){
		...
		if(pw==pw2){
			$("#txt_pw").html("<span class='mvalign black'>* 비밀번호가 일치입니다.</span>")
		}else{
			$("#txt_pw").html("<span class='mvalign black'>* 비밀번호가 일치하지 않습니다.</span>")
		}
	}//pw_check
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li id="txt_idCheck" style="padding-left: 7px;></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li class="pt5"><input type="text" name="address2" id="address2" class="addressType" /></li>
											<li class="cb">
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								...
								<li><a onclick="submitBtn()" class="sbtnMini">가입하기</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
