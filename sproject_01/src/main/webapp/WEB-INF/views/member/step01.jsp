								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li><span class="mvalign">※ @를 포함한 이메일을 입력하시오.</span></li>
										</ul>
									</td>
								</tr>
								...
								<tr id="confirm" style="display: none;">
									...
									<td>
										<ul class="pta">
											...
											<li><a class="nbtnMini" onclick="confirmBtn()">인증확인</a></li>
											<li class="pt5"><span class="mvalign">이메일로 전송된 인증번호를 입력하시오.</span></li>
										</ul>
									</td>
								</tr>
