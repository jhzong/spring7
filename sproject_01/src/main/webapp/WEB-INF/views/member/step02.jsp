		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								...
								<li><a onclick="confirmBtn()" class="sbtnMini">가입하기</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
					...
					function confirmBtn(){
						console.log("채크박스 개수 : ",$("input[type='checkbox']").length)
						console.log("채크된 개수 : ",$("input[type='checkbox']:checked").length)
						const num = $("input[type='checkbox']:checked").length
						if(num==3){
							alert("step03로 진행합니다.")
