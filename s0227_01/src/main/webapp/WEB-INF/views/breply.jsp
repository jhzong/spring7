...
<body>
  ...
  <div class="write-container">
    <div class="write-title">게시글 답글쓰기</div>
    ...
    class="write-form" id="writeForm" enctype="multipart/form-data">
      ...
      <input type="text" id="writer" value="${session_id}" placeholder="작성자" maxlength="20" readonly required />
